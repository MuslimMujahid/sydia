...
- Toolbar: "Judul 1/2/3", "Daftar berpoin/bernomor", "Tebal", "Miring", "Garis bawah", "Tambah tautan" → textbox "Alamat tautan" (placeholder `https://contoh.com`) + "Terapkan". There is no font-size control. Keep a ProseMirror text selection alive via the Range API before clicking mark buttons.
