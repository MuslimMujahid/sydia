...
export class ContactsController {
  ...
  @Get() list(@Session() session: UserSession, @Query('q') query?: string) {
    return this.contacts.list(session.user.id, query);
  }
  ...
  @Post() create(
    ...
    return this.contacts.create(session.user.id, input);
  }
